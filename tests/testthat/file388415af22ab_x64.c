...
extern void file388415af22ab_x64_ode_solver_ptr();



// prj-specific differential eqns
void file388415af22ab_x64_dydt(unsigned int _neq, double t, double *__zzStateVar__, double *__DDtStateVar__)
{
double 
		y,
	r,
	...
	__DDtStateVar__[0]=_InfusionRate(0)+r*y*(1-y/safe_zero(K));
    _dadt_counter_inc();
}

// Jacobian derived vars
void file388415af22ab_x64_calc_jac(unsigned int _neq, double t, double *__zzStateVar__, double *__PDStateVar__, unsigned int __NROWPD__) {
  _jac_counter_inc();
}
// Functional based initial conditions.
void file388415af22ab_x64_inis(SEXP _ini_sexp){
...
void file388415af22ab_x64_calc_lhs(double t, double *__zzStateVar__, double *_lhs) {
double 
		__DDtStateVar_0__,
	y,
	r,
	...
	__DDtStateVar_0__=_InfusionRate(0)+r*y*(1-y/safe_zero(K));

}
extern SEXP file388415af22ab_x64_model_vars(){
	SEXP lst      = PROTECT(allocVector(VECSXP, 12));
	SEXP names    = PROTECT(allocVector(STRSXP, 12));
	SEXP params   = PROTECT(allocVector(STRSXP, 2));
	...
	SET_STRING_ELT(params,0,mkChar("r"));
	SET_STRING_ELT(params,1,mkChar("K"));
	SET_STRING_ELT(state,0,mkChar("y"));
	stateRm[0] = 0;
	SET_STRING_ELT(modeln,0,mkChar("model"));
	SET_STRING_ELT(model,0,mkChar("d/dt(y) = r * y * (1 - y/K);\n"));
	SET_STRING_ELT(modeln,1,mkChar("normModel"));
	SET_STRING_ELT(model,1,mkChar("d/dt(y)=r*y*(1-y/K);\n"));
	SET_STRING_ELT(modeln,2,mkChar("parseModel"));
	SET_STRING_ELT(model,2,mkChar("__DDtStateVar__[0] = _InfusionRate(0) + r*y*(1-y/safe_zero(K));\n"));
	SET_STRING_ELT(modeln,3,mkChar("expandModel"));
	SET_STRING_ELT(model,3,mkChar("d/dt(y) = r * y * (1 - y/K);\n"));
	...
	SET_STRING_ELT(mmd5,0,mkChar("e667e423df4a23f7a3ab27568b31affd"));
	SET_STRING_ELT(mmd5n,1,mkChar("parsed_md5"));
	SET_STRING_ELT(mmd5,1,mkChar("53593ff1fd32b5d56902436d0bd5e597"));
	SET_STRING_ELT(trann,0,mkChar("jac"));
	SET_STRING_ELT(tran,0,mkChar("fullint"));
	SET_STRING_ELT(trann,1,mkChar("prefix"));
	SET_STRING_ELT(tran, 1,mkChar("file388415af22ab_x64_"));
	SET_STRING_ELT(trann,2,mkChar("dydt"));
	SET_STRING_ELT(tran, 2,mkChar("file388415af22ab_x64_dydt"));
	SET_STRING_ELT(trann,3,mkChar("calc_jac"));
	SET_STRING_ELT(tran, 3,mkChar("file388415af22ab_x64_calc_jac"));
	SET_STRING_ELT(trann,4,mkChar("calc_lhs"));
	SET_STRING_ELT(tran, 4,mkChar("file388415af22ab_x64_calc_lhs"));
	SET_STRING_ELT(trann,5,mkChar("model_vars"));
	SET_STRING_ELT(tran, 5,mkChar("file388415af22ab_x64_model_vars"));
	SET_STRING_ELT(trann,6,mkChar("ode_solver"));
	SET_STRING_ELT(tran, 6,mkChar("file388415af22ab_x64_ode_solver"));
	SET_STRING_ELT(trann,7,mkChar("ode_solver_sexp"));
	SET_STRING_ELT(tran, 7,mkChar("file388415af22ab_x64_ode_solver_sexp"));
	SET_STRING_ELT(trann,8,mkChar("ode_solver_0_6"));
	SET_STRING_ELT(tran, 8,mkChar("file388415af22ab_x64_ode_solver_0_6"));
	SET_STRING_ELT(trann,9,mkChar("ode_solver_focei_eta"));
	SET_STRING_ELT(tran, 9,mkChar("file388415af22ab_x64_ode_solver_focei_eta"));
	SET_STRING_ELT(trann,10,mkChar("ode_solver_ptr"));
	SET_STRING_ELT(tran, 10,mkChar("file388415af22ab_x64_ode_solver_ptr"));
	SET_STRING_ELT(trann,11,mkChar("inis"));
	SET_STRING_ELT(tran, 11,mkChar("file388415af22ab_x64_inis"));
...
extern void file388415af22ab_x64_ode_solver(
                    int *neq,
                    double *theta,      //order:
                    double *time,
                    int *evid,
...
extern void file388415af22ab_x64_ode_solver_ptr  (){
  _assign_fn_pointers(file388415af22ab_x64_dydt , file388415af22ab_x64_calc_lhs , file388415af22ab_x64_calc_jac, file388415af22ab_x64_inis, 2 , 22,
#ifdef __DEBUG__
                      1
#else
                      0
...
extern SEXP file388415af22ab_x64_ode_solver_sexp (// Parameters
                                 SEXP sexp_theta,
                                 SEXP sexp_inits,
                                 SEXP sexp_lhs,
				 // Events
...
static R_NativePrimitiveArgType file388415af22ab_x64_ode_solverrx_t[] = {
...
static R_NativePrimitiveArgType  file388415af22ab_x64_ode_solver_0_6rx_t[] = {
  //*neq, *theta, *time,  *evid, *ntime, *inits,   *dose,   *ret,     *atol,  *rtol,   *stiff, *transit_abs, *nlhs, *lhs, *rc
...
void R_init_file388415af22ab_x64 (DllInfo *info){
  ...
  R_RegisterCCallable("file388415af22ab_x64","file388415af22ab_x64_ode_solver",       (DL_FUNC) file388415af22ab_x64_ode_solver);
  R_RegisterCCallable("file388415af22ab_x64","file388415af22ab_x64_ode_solver_sexp",  (DL_FUNC) file388415af22ab_x64_ode_solver_sexp);
  R_RegisterCCallable("file388415af22ab_x64","file388415af22ab_x64_ode_solver_0_6",   (DL_FUNC) file388415af22ab_x64_ode_solver_0_6);
  R_RegisterCCallable("file388415af22ab_x64","file388415af22ab_x64_ode_solver_ptr",   (DL_FUNC) file388415af22ab_x64_ode_solver_ptr);

  /* R_registerRoutines(info, NULL, NULL, NULL, NULL); */
  /* R_useDynamicSymbols(info,TRUE); */

  static const R_CMethodDef cMethods[] = {
    {"file388415af22ab_x64_ode_solver", (DL_FUNC) &file388415af22ab_x64_ode_solver, 15, file388415af22ab_x64_ode_solverrx_t},
    {"file388415af22ab_x64_ode_solver_0_6", (DL_FUNC) &file388415af22ab_x64_ode_solver_0_6, 21, file388415af22ab_x64_ode_solver_0_6rx_t},
    {NULL, NULL, 0, NULL}
  };
  
  R_CallMethodDef callMethods[]  = {
    {"file388415af22ab_x64_ode_solver_ptr", (DL_FUNC) &file388415af22ab_x64_ode_solver_ptr, 0},
    {"file388415af22ab_x64_ode_solver_sexp", (DL_FUNC) &file388415af22ab_x64_ode_solver_sexp, 23},
    {"file388415af22ab_x64_model_vars", (DL_FUNC) &file388415af22ab_x64_model_vars, 0},
    {"file388415af22ab_x64_inis", (DL_FUNC) &file388415af22ab_x64_inis, 1},
    {NULL, NULL, 0}
  };
