...
rxPermissive({
    ...
    test_that("top n works",{
        expect_equal(round(as.data.frame(top_n(o1.first,3,depot)),4),
                     structure(list(time = c(48, 72, 96), depot = c(10009.2745, 10009.2745, 10009.2745), centr = c(191.4312, 231.7507, 255.4203), peri = c(3679.3816, 4479.633, 4949.4198), eff = c(1.0247, 1.0298, 1.0328), C2 = c(4.762, 5.7649, 6.3537), C3 = c(12.3885, 15.0829, 16.6647)), row.names = c(NA, -3L), .Names = c("time", "depot", "centr", "peri", "eff", "C2", "C3"), class = "data.frame"))
    })
